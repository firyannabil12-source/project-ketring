...
<head>
    ...
    <style>
        ...
        .cart-btn:hover { background: var(--primary, #E8572A); color: white; }
        .cart-count {
    ...
    <header class="navbar">
        <div class="container">
            ...
            <nav class="nav-links">
                ...
                <a href="{{ route('orders') }}" class="{{ request()->routeIs('orders') ? 'active' : '' }}">Pesanan</a>
            ...
            <div class="cart-item">
                ...
                <div class="cart-item-info">
                    ...
                    <div class="cart-qty-ctrl">
                        <button class="qty-btn" onclick="updateQty(${item.menu_id}, ${item.quantity - 1})">−</button>
                ...
                <div style="display:flex; flex-direction:column; align-items:flex-end; gap:0.5rem;">
                    ...
                    <button class="cart-item-remove" onclick="removeFromCart(${item.menu_id})" title="Hapus">🗑️</button>
                </div>
            </div>`;
        }).join('');
