        ...
        <div
            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div style="margin-bottom: 1.5rem;">
                    <label for="name"
                        style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #334155; font-size: 0.875rem;">Nama
                        Lengkap</label>
                ...
                <div style="margin-bottom: 2rem;">
                    <label for="password_confirmation"
                        style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #334155; font-size: 0.875rem;">Konfirmasi
                        Password</label>
                ...
                <button type="submit" class="btn btn-primary"
                    style="width: 100%; justify-content: center; padding: 0.875rem; font-size: 1rem;">Daftar</button>
            </form>

            <div style="text-align: center; margin-top: 1.5rem; font-size: 0.875rem; color: #64748b;">
                Sudah punya akun? <a href="{{ route('login') }}"
                    style="color: #E8572A; font-weight: 600; text-decoration: none;">Masuk di sini</a>
            </div>
        </div>
    </div>
@endsection
