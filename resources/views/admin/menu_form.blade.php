...
@section('content')
    <div class="form-card">
        <div class="form-card-header">
            <h2>{{ isset($menu) && $menu->exists ? 'Edit Menu: ' . $menu->name : 'Tambah Menu Baru' }}</h2>
        </div>

        <form method="POST"
            action="{{ isset($menu) && $menu->exists ? route('admin.menu.update', $menu) : route('admin.menu.store') }}"
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name', $menu->name ?? '') }}"
                            placeholder="cth: Paket Nasi Kotak A" required>
                        @error('name')
                    ...
                    <div class="form-group full">
                        ...
                        <input type="file" name="image" id="imageInput" accept=".png, image/png"
                        ...
                        @if (isset($menu) && $menu->exists && $menu->image)
                            <div style="font-size: 0.8rem; margin-top: 0.5rem; color: #64748b;">
                                Gambar saat ini: <a
                                    href="{{ Str::startsWith($menu->image, 'http') ? $menu->image : asset($menu->image) }}"
